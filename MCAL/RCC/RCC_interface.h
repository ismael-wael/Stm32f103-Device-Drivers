...
#define RCC_PLL_HSI_BY2   5         /*HSI Division by 2*/
#define RCC_PLL_HSE       6         /*HSE (No Division)*/
#define RCC_PLL_HSE_BY2   7         /*HSE Division by 2*/
...
/* Clock Security System :
    > Enabled : - Set HSI by H.W. when there are failure in HSE 
